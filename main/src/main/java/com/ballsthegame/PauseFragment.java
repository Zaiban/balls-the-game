...
public class PauseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Bind a Listener on the returnGameButton
        returnGameButton = (Button) rootView.findViewById(R.id.button_returngame);
        returnGameButton.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                mCallback.onReturnGame();
            }
        });
